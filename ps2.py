...
class TrainAudioSpectrogramDataset(Dataset):
    ...
    """
    def _init_(self, root_dir, categories, max_frames=512, fraction=1.0):
...
class CGAN_Generator(nn.Module):
    def _init_(self, latent_dim, num_categories, spec_shape=(128, 512)):
        super()._init_()
...
class CGAN_Discriminator(nn.Module):
    def _init_(self, num_categories, spec_shape=(128, 512)):
        super()._init_()
        self.num_categories = num_categories
        self.spec_shape = spec_shape
        H, W = spec_shape
